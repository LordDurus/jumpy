...
fn gravity_mult_to_q4_4(v: f32) -> Result<u8, String> {
    if !v.is_finite() {
    ...
    if v < 0.0 || v > 15.9375 {
        return Err(format!(
            "gravity multiplier {} out of range (0..15.9375)",
            v
        ));
    }
