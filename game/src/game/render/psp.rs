...
use psp::sys::{SCE_DISPLAY_MODE_LCD, SCE_GU_CLEAR_ALL, SCE_GU_SYNC_WAIT, SceDisplaySetMode, sceDisplaySetMode, sceGuFinish, sceGuStart, sceGuSync};
...
impl Renderer for PspRenderer {
	...
	fn render_frame(&mut self, _world: &mut level) {
		unsafe {
